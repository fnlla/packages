...
final class MakeServiceCommand extends AbstractMakeCommand implements CommandInterface
{
    ...
    public function run(array $args, array $options, ConsoleIO $io, string $root): int
    {
        ...
        $template = $root . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR . 'Fnlla' . DIRECTORY_SEPARATOR . 'console' . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'service.stub';
        if (!is_file($template)) {
            $template = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'service.stub';
        }
